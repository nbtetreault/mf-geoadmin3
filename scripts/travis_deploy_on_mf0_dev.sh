...
rsync -e 'ssh -i .ssh/id_rsa -o StrictHostKeyChecking=no -o ProxyCommand="ssh -i -o StrictHostKeyChecking=no .ssh/id_rsa -Aq travis@ssh0.prod.bgdi.ch nc -q0 %h 22"' -Cavz ./prd travis@mf0.dev.bgdi.ch:/home/travis/sync
